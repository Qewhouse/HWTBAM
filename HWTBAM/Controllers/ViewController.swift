...
"""
    ...
    private let startButton: UIButton = {
       let button = UIButton()
        ...
        button.layer.borderColor = .init(red: 150, green: 55, blue: 256, alpha: 1.0)
...
//            logoImage.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -100),
            
            labelStackView.topAnchor.constraint(equalTo: logoImage.bottomAnchor, constant: 100),
